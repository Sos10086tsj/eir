 ...
 * Date:Nov 30, 2016
**/
public class MoItemCpq extends BaseModel{
	...
	public Integer getBoxFrom() {
		return boxFrom;
	}
	public Integer getBoxTo() {
		return boxTo;
	}
	...
	public void setBoxFrom(Integer boxFrom) {
		this.boxFrom = boxFrom;
	}
	public void setBoxTo(Integer boxTo) {
		this.boxTo = boxTo;
	}
